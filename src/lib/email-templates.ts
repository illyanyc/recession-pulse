    ...
    html: wrapper(`
      ...
      <div style="background:#0D0D0D;border:1px solid #2A2A2A;border-radius:0px;padding:20px;margin-bottom:20px;">
        ...
        <table style="width:100%;border-collapse:collapse;">
          <tr><td style="padding:6px 0;color:#F0913A;font-size:13px;font-weight:600;">-</td><td style="padding:6px 8px;color:#D4D4D4;font-size:13px;">43 recession indicators tracked daily</td></tr>
