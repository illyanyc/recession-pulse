        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-pulse-muted text-lg mb-8 leading-relaxed">
              ...
              {" "}{INDICATOR_COUNT} indicators distilled into one glance. <span className="text-white font-medium">Email briefings are free</span> — upgrade
              to Pulse for SMS alerts + AI analysis.
            </p>

            <div className="space-y-4">
              {[
                `${INDICATOR_COUNT} indicators analyzed — only alerts surface`,
