  ...
  return (
    <section className="relative overflow-hidden pt-20 pb-32">
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 80% 60% at 50% 40%, rgba(255,102,0,0.07) 0%, rgba(255,102,0,0.02) 40%, transparent 70%)",
        }}
      />
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-pulse-green/20 bg-pulse-green/5 mb-8">
          ...
          <span className="text-pulse-green text-sm font-medium">28 indicators tracked live</span>
        </div>
        ...
        <p className="text-lg sm:text-xl text-pulse-muted max-w-2xl mx-auto mb-10 leading-relaxed">
          28 recession and macro indicators from FRED, Treasury, and financial APIs — analyzed
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {[
            { icon: BarChart3, label: "28 macro indicators" },
