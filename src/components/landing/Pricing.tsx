      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-pulse-muted text-lg max-w-xl mx-auto">
            Start free with full dashboard access. Upgrade when you want alerts in your pocket.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className="rounded-2xl border border-pulse-border bg-pulse-card p-8 flex flex-col">
            <div className="mb-6">
              ...
              <p className="text-sm text-pulse-muted">{PLANS.free.description}</p>
            </div>

            <div className="mb-8">
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-bold text-white">$0</span>
                <span className="text-pulse-muted">/forever</span>
              </div>
            </div>
